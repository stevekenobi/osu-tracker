...
export default class TrackerServer {
  ...
  _initClients(): void {
    ...
    TrackerServer.sheetClient = new SheetClient(process.env['LEADERBOARD_SHEET_ID'] ?? '', process.env['UNFINISHED_SHEET_ID'] ?? '', process.env['BEATMAPS_SHEET_ID'] ?? '', process.env['AGES_SHEET_ID'] ?? '');
  }
